...
export default function SignupResponsive() {
    return (
        <div className="min-h-screen flex flex-col justify-center items-center bg-black text-white p-4">
            <div className="w-full max-w-md bg-black shadow-md shadow-[#9F51F6] rounded-lg p-6">
                ...
                <div className="text-sm text-white mb-4 text-center"><h5>or use your email for registration</h5></div>
                <form className="flex flex-col gap-4">
                    ...
                    <input
                        ...
                        required
                    />
                    <div className="flex justify-center text-white font-bold mt-4">
                ...
                <div className="mt-4 text-center">
                    <Link to="/loginresponsive" className="text-[#9F51F6] hover:underline font-semibold">
