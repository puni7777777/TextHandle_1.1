        ...
        <div className="py-8 flex flex-col gap-4 w-2/4 h-full items-center rounded-lg">
            ...
            <div className="flex gap-4">
                <a href="#" role="button" className="h-9">
                    <div className="rounded-full mb-2 inline-block p-3 text-xs shadow-sm transition-all ease-in-out fill-white shadow-white hover:fill-blue-500 hover:shadow-blue-500 hover:cursor-pointer hover:outline-dotte">
